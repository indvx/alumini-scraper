    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div
            ...
            <div class="border-b border-slate-100 dark:border-slate-800 pb-5 mb-6">
                <h1 class="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">Edit: {{ $institution->name }}</h1>
            ...
            <form action="{{ route('institutions.update', $institution) }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border @error('name') border-rose-500 @else border-slate-300 dark:border-slate-700 @enderror text-slate-900 dark:text-white text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all">
                        @error('name')
                    ...
                    <div>
                        ...
                        <select id="type" name="type" required
                            class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border @error('type') border-rose-500 @else border-slate-300 dark:border-slate-700 @enderror text-slate-900 dark:text-white text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all">
                ...
                <div class="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <div>
                        <label for="address"
                            class="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1">Street Address</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 items-start" id="editInstitutionLocationContainer">
                        <!-- Country Lookup -->
                        <div class="relative">
                        ...
                        <div id="editStateContainer" class="relative">
                            <label for="editStateInput"
                                class="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1">State / Province</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            <label for="postcode"
                                class="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1">Postcode / ZIP</label>
                            <input type="text" id="postcode" name="postcode"
                                value="{{ old('postcode', $institution->postcode) }}"
                                class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all">
                        </div>

                        <div>
                            <label for="latitude"
                                class="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1">Latitude</label>
                        ...
                        <div>
                            <label for="longitude"
                                class="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1">Longitude</label>
                ...
                <div class="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label for="phone"
                                class="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1">Phone Number</label>
                        ...
                        <div>
                            <label for="website"
                                class="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1">Website URL</label>
                            <input type="url" id="website" name="website"
                                value="{{ old('website', $institution->website) }}" placeholder="https://example.edu"
                                class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border @error('website') border-rose-500 @else border-slate-300 dark:border-slate-700 @enderror text-slate-900 dark:text-white text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all">
                            @error('website')
                                <p class="text-xs text-rose-500 mt-1 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="pt-6 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-3">
                    <button type="button"
                        ...
                        onclick="if(confirm('Are you sure you want to delete this institution?')) document.getElementById('delete-institution-form').submit();"
                        class="px-4 py-2.5 rounded-xl bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-900 text-rose-700 dark:text-rose-300 hover:bg-rose-100 text-xs font-bold transition-all">
                        Delete Institution
                    </button>
                    <div class="flex items-center gap-2">
                        <a href="{{ route('institutions.show', $institution) }}"
                            title="Cancel edits and return to institution details"
                        ...
                        <button type="submit"
                            title="Save updated institution details"
