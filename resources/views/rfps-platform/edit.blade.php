    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div
            ...
            <div class="border-b border-slate-100 dark:border-slate-800 pb-5 mb-6">
                <h1 class="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">Edit: {{ $platform->name }}</h1>
            ...
            <form action="{{ route('rfps-platform.update', $platform) }}" method="POST" class="space-y-6">
                ...
                <div class="pt-6 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-2">
                    <a href="{{ route('rfps-platform.show', $platform) }}"
                        title="Cancel editing and return to platform details"
                    ...
                    <button type="submit"
                        title="Save updated procurement platform details"
